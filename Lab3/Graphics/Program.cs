            ...
            do
            {
                ...
                switch (selection)
                {
                    case 1:
                        ...
                        Point2D randomPoint = new Point2D(random.Next(Console.WindowWidth), random.Next(Console.WindowHeight));
                        Shape shape = new Shape(randomPoint, ConsoleColor.Cyan);
                        shape.Draw();
                        break;
                    ...
                    case 2:
                        ...
                        Point2D start = new Point2D(randomLine.Next(Console.WindowWidth), randomLine.Next(Console.WindowHeight));
                        Point2D end = new Point2D(randomLine.Next(Console.WindowWidth), randomLine.Next(Console.WindowHeight));
                        Line line = new Line(start, end, ConsoleColor.Green);
                        line.Draw();
                        break;
                    ...
                    case 3:
                        ...
                        Random randomRect = new Random();
                        int x = randomRect.Next(maxWidth);
                        int y = randomRect.Next(maxHeight);
                        int width = randomRect.Next(maxWidth - x);
                        int height = randomRect.Next(maxHeight - y);
                        ConsoleColor rectColor = ConsoleColor.Magenta;
                        Rectangle rect = new Rectangle(width, height, new Point2D(x, y), rectColor);
                        rect.Draw();
                        break;
                    ...
                    case 4:
                        ...
                        Point2D p1 = new Point2D(rand.Next(1, Console.WindowWidth + 1), rand.Next(1, Console.WindowHeight + 1));
                        Point2D p2 = new Point2D(rand.Next(1, Console.WindowWidth + 1), rand.Next(1, Console.WindowHeight + 1));
                        Point2D p3 = new Point2D(rand.Next(1, Console.WindowWidth + 1), rand.Next(1, Console.WindowHeight + 1));
                        Triangle triangle = new Triangle(p1, p2, p3, ConsoleColor.Gray);
                        triangle.Draw();
                        Console.ReadKey();
                        break;
                    case 5:
                        ...
                        int centerX = randomCircle.Next(0, maxX);
                        int centerY = randomCircle.Next(0, maxY);
                        int maxRadius = Math.Min(centerX, Math.Min(centerY, Math.Min(maxX - centerX, maxY - centerY)));
                        int minValue = 1;
                        int maxValue = maxRadius;
                        ...
                        int radius = randomCircle.Next(minValue, maxValue + 1);
                        Circle circle = new Circle(radius, new Point2D(centerX, centerY), ConsoleColor.Red);
                        circle.Draw();
                        break;
                    ...
                    case 6:
                        ...
                        for (int i = 0; i < 100; i++)
                        {
                            int shapeType = randomShapes.Next(5);
                            switch (shapeType)
                            {
                                case 0:
                                    shapes.Add(new Shape(new Point2D(randomShapes.Next(80), randomShapes.Next(25)), (ConsoleColor)randomShapes.Next(16)));
                                    break;
                                case 1:
                                    shapes.Add(new Line(new Point2D(randomShapes.Next(80), randomShapes.Next(25)), new Point2D(randomShapes.Next(80), randomShapes.Next(25)), (ConsoleColor)randomShapes.Next(16)));
                                    break;
                                case 2:
                                    shapes.Add(new Rectangle(randomShapes.Next(5, 30), randomShapes.Next(5, 20), new Point2D(randomShapes.Next(80), randomShapes.Next(25)), (ConsoleColor)randomShapes.Next(16)));
                                    break;
                                case 3:
                                    shapes.Add(new Triangle(new Point2D(randomShapes.Next(80), randomShapes.Next(25)), new Point2D(randomShapes.Next(80), randomShapes.Next(25)), new Point2D(randomShapes.Next(80), randomShapes.Next(25)), (ConsoleColor)randomShapes.Next(16)));
                                    break;
                                case 4:
                                    shapes.Add(new Circle(randomShapes.Next(5, 15), new Point2D(randomShapes.Next(80), randomShapes.Next(25)), (ConsoleColor)randomShapes.Next(16)));
                                    break;
                            }
                        }
